...
export const AUTH = {
  ...
  LOGOUT: process.env.REACT_APP_AUTH_LOGOUT || '/api/logout',
  SWITCH_TENANT: process.env.REACT_APP_AUTH_SWITCH || '/api/switch-tenant',
...
export const ENDPOINTS = {
  ADMIN_SETTINGS:
    process.env.REACT_APP_ENDPOINT_ADMIN || '/api/data/admin/settings',
  REPORTS: process.env.REACT_APP_ENDPOINT_REPORTS || '/api/data/reports',
